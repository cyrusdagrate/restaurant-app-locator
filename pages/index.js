        ...
        <div className={classes.root}>
          ...
          <GridList cellHeight={176} className={classes.gridList}>
            {data &&
              data.map((tile, index) => (
                <GridListTile
                  key={tile.backgroundImageURL}
                  cols={isMobile || matches ? 1 : 2}
                  rows={1}
                ...
                >
                  ...
                  <GridListTileBar
                    title={tile.name}
                    subtitle={
                      <span className={classes.subtitle}>{tile.category}</span>
                    }
          ...
          >
            ...
            <div className="resContact">
              <p className="resContactAddress">
                {detail && detail?.location.formattedAddress[0]}
              </p>
              <p>{detail && detail?.location?.formattedAddress[1]}</p>
              <p className="resContactPhone">
                {detail && detail?.contact?.formattedPhone}
              </p>
              <p className="resContactPhone">
                {detail?.contact?.twitter ? "@" + detail?.contact?.twitter : ""}
              </p>
            </div>
            {!isIOS ? (
